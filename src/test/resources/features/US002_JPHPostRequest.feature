...
#    "id": 70                               "id": 70
#   }                                     }
 Feature: US002 POST Request

   Scenario: POST Request yaparak donen responstaki degerlerin
     ...
     Then kullanici "Server" isimli header degerinin "keep-alive" oldugunu kontrol eder
